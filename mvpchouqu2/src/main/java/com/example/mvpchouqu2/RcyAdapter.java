...
public class RcyAdapter extends RecyclerView.Adapter {
    ...
    public RcyAdapter(ArrayList<Bean.ResultsBean> list, Context context) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.init_rcy, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        Glide.with(context).load(resultsBean.getUrl()).into(holder1.im);
